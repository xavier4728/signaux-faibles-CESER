...
export function ChatBot({ taskId }: ChatBotProps) {
  ...
  const sendMessage = useCallback(async (overrideText?: string) => {
    ...
    if (!text.trim() || !taskId || loading) return;
          ...
          <div className="flex items-center justify-between bg-[var(--color-ceser-blue)] px-4 py-3">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-[10px] text-white/70">Analyse en cours</p>
              </div>
            </div>
            ...
            {messages.length === 0 && (
              <div className="flex h-full flex-col items-center justify-center text-center">
                ...
                <p className="mt-1 max-w-[260px] text-xs text-muted-foreground">
                  Posez-moi une question sur les résultats de l&apos;analyse : préconisations, scores, correspondances...
                </p>
                <div className="mt-4 flex flex-wrap justify-center gap-1.5">
                  {[
                    "Résumé des résultats ?",
                    "Quelles précos n'ont pas matché ?",
